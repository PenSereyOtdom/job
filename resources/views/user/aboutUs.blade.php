...
<div class="about-us container">
    ...
    <div class="mt-5">
        <h3 class="font-weight-bold text-center">Who are we?</h3>
    ...
    <div class="px-5 mt-5">
        <h3 class="font-weight-bold text-center">Our Value</h3>
        <ul>
    ...
    <div class="px-5 my-5">
        <h3 class="font-weight-bold text-center">Core Value</h3>
        <ul>
