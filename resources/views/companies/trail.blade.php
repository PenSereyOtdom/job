    ...
    <div class="pay container">
        <div class="profile card mb-5">
            <div class="container px-5 py-4">
                ...
                <form class="form-horizontal" method="POST" action="{{url('/trail')}}" enctype="multiple/form-data">
                    {!! csrf_field() !!}
                    <input name="admin_id" value="1" type="hidden">
                    <input name="service_id" value="1" type="hidden">

                    <h3 class="font-weight-bold pb-3">@lang('company.howyouwanttopay')</h3>

                    <div class="row my-3">
                        <div class="col-2"><p class="text-secondary small mb-0">@lang('company.servicetype')</p> <p>@lang('company.classic')</p></div>
                ...
                @elseif ($service_approval__check[0]->approve == 0)
                    <h3 class="font-weight-bold pb-3">You have purchased Trail Plan.</h3>
                    <p>Your Request has been sent to Admin.</p>
                    <p>We will contact you soon.</p>
                    <p>Thank You!</p>
                @else
                    <h3 class="font-weight-bold pb-3">Trail Plan.</h3>
                    <p>You cannot purchase more ticket. Please use your remaining first.</p>
                    <p>Your remaining ticket: {{$service_approval__check[0]->post_number}}.</p>  
                @endif  
            </div>
        </div>
    </div>
