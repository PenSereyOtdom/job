        ...
        <div class="profile card mb-5">
            ...
            <div class="container px-5 py-4">
                ...
                <form class="form-horizontal" method="POST" action="{{url('/urgent')}}" enctype="multiple/form-data">
                    ...
                    <div class="row my-3">
                        <div class="col-2"><p class="text-secondary small mb-0">@lang('company.servicetype')</p> <p>@lang('company.urgent')</p></div>
                        <div class="col-2"><p class="text-secondary small mb-0">@lang('company.price')</p> <p>60$</p></div>
                    </div>
