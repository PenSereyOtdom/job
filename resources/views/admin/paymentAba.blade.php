    ...
    <div class="container">
        <div class="profile card mb-5">
            <div class="container px-5 py-4">
                <h3 class="font-weight-bold">ABA Method</h3>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="col-8 pl-0">
                                <div class="justify-content-center">
                                    @if($editPayment->qr_aba)
                                        <img class="card-img-top profile-pic qr-pic img-thumbnail" src="{{ asset('storage/qr_aba/' . $editPayment->qr_aba) }}" />
                                    @else
                                        <img class="card-img-top profile-pic qr-pic img-thumbnail" src="{{asset('/img/qr.jpg')}}" />
                                    @endif
                                    <div class="p-image text-center">
                                        <i class="fa fa-camera upload-button"></i>
                                        <input class="file-upload" name="qr_aba" type="file" id="" accept="image/*" style="display:none;"/>
                                    </div>
                                </div>
                            </div>  
                        </div>
                        <div class="col-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="acc_number" value="{{$editPayment->acc_number}}" placeholder="Please enter your firstname..." class="form-control">
                            </div>
